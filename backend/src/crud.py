...
def audit_report_zip_file(db: Session, Project_id: int, Cycle_id: int, from_date: str, to_date: str):
    ...
    s = io.BytesIO()
    zip_name = f"audit_{from_date}_{to_date}.zip"
